...
def build_character_extract_prompt(*, work_title: str, genre: str, synopsis: str, limit: int) -> str:
    return dedent(
        ...
        {{
          "characters": [
            {{
              ...
              "age": "선택, 10자 이내",
              "role": "선택, 10자 이내",
              "profile_label": "직업/소속/정체성. 예: 형사, 야구부 주장, 재벌가 후계자, 마법사 길드장. 80자 이내",
              "gender": "선택, 10자 이내",
        ...
        - role: 작품 내 역할. 예: 주인공, 조력자, 악역, 라이벌, 연인, 가족, 동료, 스승, 기타
        - profile_label: 관계도 카드에서 이름 아래에 보일 핵심 표시 정보다.
          직업, 소속, 신분, 조직 내 위치 중 가장 알아보기 쉬운 표현 하나로 작성한다.
